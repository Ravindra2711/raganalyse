...
if USE_DSPY:
    import dspy
    default_lm = MODEL_OBJECTS.get(DEFAULT_MODEL_CONFIG['model'])
...
# In Autogen-only mode, we pass None for chat_history_name_agent
app.state = AppState(styling_instructions, None, DEFAULT_MODEL_CONFIG)
